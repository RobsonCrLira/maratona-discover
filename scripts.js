...
const Utils = {
    formatAmount(value) {
        ...
        //value = Number(value.replace(/\,\./g,(""))) * 100 // outra forma de fazer
        return value;
    },
    ...
    formatCurrency(value) {
        ...
        value = String(value).replace(/\D/, "") //Busca explicação no video 1:10:00 ~ 1:13:00

        value = Number(value) / 100

        //toLocateSting é para "setar" a localização do objeto informado exemplo: pt-BR -> Brasil ou pt-PT -> Portugal
